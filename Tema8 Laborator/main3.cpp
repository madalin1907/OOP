...
int main() {
    ...
    /*
        Q: Cum putem refolosi codul de mai sus pentru a extinde pentru mai multe tipuri de date pe care face CRUD?
    E.g. Building si Owner in acelasi meniu.

        A:  Pentru fiecare clasa se creaza un meniu separat in care se suprascriu functiile listOption,
     chooseOption si mainLoop + functiile specifice tipului de date, apoi se creeaza un alt meniu principal
     cu cele trei functii (listOption, chooseOption si mainLoop) unde va trebui ales mai intai tipul de date pe care
     se vrea efectuarea unor operatii, iar in functie de alegerea utilizatorului se va deschide meniul
     specific acelei clase. (Asemanator cu ce am facut la exercitiul 4).
    */
}